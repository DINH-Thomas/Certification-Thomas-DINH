...
# To do if it isn't already done, uncomment the two following lines
...
def _wordnet_pos(treebank_tag: str) -> str:
    """Check the nature of the word to lemmatize (adjective, verb, noun, adverb) for better lemmatization results :
    - J for adjectives
    - V for verbs
    - N for nouns
    - R for adverbs
